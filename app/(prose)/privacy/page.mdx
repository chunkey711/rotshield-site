export const metadata = {
  ...
  description: 'Rotshield has no server, no account and no analytics. Nothing leaves your iPhone.',
};

# Privacy Policy

<p className="effective">Effective 1 September 2026</p>
...
<div className="contact">ruslan.d@scalemate.co — Ruslan Dzhafarov, Poland.</div>
